...
const caseStudies = [
  ...
  },
  {
    ...
    title: 'Upgrade Visitor Experience with IDS Visitor Management Software',
    description: 'Digital visitor registration with pre-booking, self-service kiosks, and real-time host notifications. Replace paper logbooks with enterprise VMS.',
    image: 'https://images.unsplash.com/photo-1565043666747-69f6646db940?q=80&w=2074&auto=format&fit=crop',
    link: '/solutions/vms-software',
  },
  {
    id: 3,
