...
export default function UVPrintingPage() {
  const pageTitle = 'UV Invisible Ink Printing';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <main className="w-full lg:w-3/4 order-1 lg:order-2">
            <FadeIn>
              <SolutionHero title={pageTitle} image="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop" />
