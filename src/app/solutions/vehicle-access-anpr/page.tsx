...
import { Breadcrumb, SolutionSidebar, SolutionHero, iotRoboticsMenu } from '@/components/solutions';
...
export default function VehicleAccessANPRPage() {
  const pageTitle = 'Vehicle Access & ANPR Solutions';
