...
import { Breadcrumb, SolutionSidebar, SolutionHero, identityAccessMenu } from '@/components/solutions';
...
export default function GateAutomationPage() {
  const pageTitle = 'Gate Automation Systems';
          ...
          <main className="w-full lg:w-3/4 order-1 lg:order-2">
            <FadeIn>
              ...
              <div className="prose prose-invert prose-lg max-w-none mb-12">
                ...
                <p className="text-gray-400">
                  Leveraging advanced algorithms and state-of-the-art hardware, this solution integrates seamlessly with your existing technology stack, reducing overhead and improving efficiency from day one.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-white/5 to-transparent border border-white/10 rounded-3xl p-8 md:p-12 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 mb-8 max-w-2xl">
                    Schedule a consultation with our solution architects to design a system tailored to your unique requirements.
                  </p>
