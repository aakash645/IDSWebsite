...
const allProducts = [
  ...
  {
    id: "automatic-boom-barrier-gate",
    name: "Automatic Boom Barrier Gate",
    category: "Access Control",
    icon: Fence,
    desc: "Automatic boom barrier with vehicle verification and secure entry control.",
    fullDesc: "A high-performance automatic boom barrier gate with intelligent vehicle recognition and integrated access control. Designed for parking, gated communities, and industrial entries with fail-safe operation.",
    price: 21999,
    features: ["Auto-Open/Close", "Remote Control", "Safety Sensors", "Power Backup"],
    specs: [
      { label: "Barrier Arm Length", value: "4m" },
      { label: "Cycle Time", value: "1.5s open/close" },
      { label: "Motor", value: "AC 220V 800W" },
      { label: "Duty Cycle", value: "30/min" },
      { label: "Operating Temp", value: "-20°C to 60°C" },
      { label: "Warranty", value: "2 years" },
    ],
    badge: "Popular",
    image: "https://cdn.pixabay.com/photo/2017/01/04/12/26/barrier-1951846_1280.jpg",
    gallery: [
      "https://cdn.cloudbf.com/thumb/format/mini_xsize/files/105/img/2025/09/27/202509271006320132043.jpg.webp",
      "https://cdn.pixabay.com/photo/2018/05/10/22/03/cars-3387833_1280.jpg",
      "https://cdn.pixabay.com/photo/2019/10/01/04/53/barrier-4514292_1280.jpg"
    ],
    sizes: ["Standard"],
    rating: 4.7,
    reviews: 98,
  ...
  {
    id: "boom-barrier-gate-system",
    name: "Boom Barrier Gate System",
    category: "Access Control",
    icon: Fence,
    desc: "Integrated boom barrier gate system with access and ticketing support.",
    fullDesc: "Complete boom barrier gate system with ticket dispenser, RFID tag reader, and camera integration. Ideal for smart parking, logistics sites, and secure facility entry.",
    price: 32999,
    features: ["RFID/Card Access", "Ticketing", "ANPR-ready", "Cloud Analytics"],
    specs: [
      { label: "Integration", value: "ANPR, RFID, Barcode" },
      { label: "Throughput", value: "80 vehicles/hour" },
      { label: "Control Mode", value: "Local + Remote" },
      { label: "Power", value: "110-230V AC" },
      { label: "IP Rating", value: "IP54" },
      { label: "Warranty", value: "3 years" },
    ],
    badge: "New",
    image: "https://cdn.pixabay.com/photo/2018/09/01/10/09/parking-3641101_1280.jpg",
    gallery: [
      "https://cdn.cloudbf.com/thumb/format/mini_xsize/files/105/img/2025/09/27/202509271006320132043.jpg.webp",
      "https://cdn.pixabay.com/photo/2019/04/08/15/59/parking-4115291_1280.jpg",
      "https://cdn.pixabay.com/photo/2016/11/16/00/17/garage-1822481_1280.jpg"
    ],
    sizes: ["Standard"],
    rating: 4.6,
    reviews: 57,
  ...
  {
    id: "anpr-ids-gate",
    name: "ANPR in IDS GATE",
    category: "Access Control",
    icon: Camera,
    desc: "Automatic Number Plate Recognition integration for IDS GATE.",
    fullDesc: "ANPR module for IDS GATE enables vehicle identification and automatic access decision making. Supports database lookup, watchlists, and event auditing for parking and restricted zones.",
    price: 28999,
    features: ["License Plate Capture", "Dark/Low-light", "Whitelist/Blacklist", "Real-time Alerts"],
    specs: [
      { label: "Camera Resolution", value: "2MP - 8MP" },
      { label: "Recognition Rate", value: "98%" },
      { label: "Environmental", value: "IP66, -30°C to 60°C" },
      { label: "Interfaces", value: "Ethernet, POE, RS485" },
      { label: "Software", value: "Web UI + API" },
      { label: "Warranty", value: "2 years" },
    ],
    badge: "Featured",
    image: "https://cdn.pixabay.com/photo/2018/07/21/21/11/license-3558814_1280.jpg",
    gallery: [
      "https://cdn.pixabay.com/photo/2018/07/21/21/11/license-3558814_1280.jpg",
      "https://cdn.pixabay.com/photo/2017/08/06/14/09/road-2597560_1280.jpg",
      "https://cdn.pixabay.com/photo/2016/01/19/15/07/number-1148995_1280.jpg"
    ],
    sizes: ["Standard"],
    rating: 4.8,
    reviews: 74,
  ...
  {
    id: "ids-gate",
    name: "IDS GATE Access Control System",
    category: "Access Control",
    icon: Shield,
    desc: "Comprehensive access control system for doors, turnstiles, and gateway zones.",
    fullDesc: "IDS GATE is a modular access control platform with support for RFID, biometric, PIN, and mobile credentials. It includes centralized dashboard monitoring, audit trails, and scalable hardware for 100+ doors.",
    price: 89999,
    features: ["RFID + Biometrics", "Cloud Dashboard", "Real-time Alerts", "Role-based Access"],
    specs: [
      { label: "Supported Doors", value: "100+" },
      { label: "Auth Modes", value: "RFID, Fingerprint, Face, PIN" },
    ...
    badge: "Best Seller",
    image: "https://cdn.cloudbf.com/thumb/format/mini_xsize/files/105/img/2025/09/26/202509261113250133168.jpg.webp",
    gallery: [
      "https://cdn.cloudbf.com/thumb/format/mini_xsize/files/105/img/2025/09/26/202509261113250133168.jpg.webp",
      "https://cdn.pixabay.com/photo/2019/04/26/16/21/data-4157963_1280.jpg",
      "https://cdn.pixabay.com/photo/2020/05/17/13/58/access-control-5184280_1280.jpg"
    ],
    sizes: ["Standard"],
    rating: 4.8,
    reviews: 184,
